...
function optionsframework_options() {
  ...
  */
  ...
  $options[] = array(
    'name' => __('Contact Sales Form ID', 'roots'),
    'desc' => __('', 'roots'),
    'id' => 'contact_sales_form_id',
    'std' => '',
    'class' => 'mini',
    'type' => 'text');
  ...
  $options[] = array(
  		'name' => __('Header Logo Link URL', 'roots'),
  		'id' => 'header-logo-link',
  		'type' => 'text',
  		'desc' => __('Enter a URL if you would like the header logo to link somewhere else other than the site homepage.', 'roots')
  	);
  ...
  $options[] = array(
	...
	$options[] = array(
    'name' => __('Facebook Share Title', 'roots'),
    'desc' => __('This title will show in the Facebook dialog window when sharing a page.', 'roots'),
    'id' => 'share-facebook-title',
    'std' => '',
    'class' => 'mini',
    'type' => 'text');

	$options[] = array(
		'name' => __('Facebook Share Description', 'roots'),
		'desc' => __('This description will show in the Facebook dialog window when sharing a page.', 'roots'),
		'id' => 'share-facebook-description',
		'std' => '',
		'type' => 'textarea');

	$options[] = array(
    'name' => __('Facebook Share Image URL', 'roots'),
    'desc' => __('This image will show in the Facebook dialog window when sharing a page.', 'roots'),
    'id' => 'share-facebook-image',
    'std' => '',
    'type' => 'text');

...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page(__('Yammer Options', 'options_framework_theme'), __('Yammer Options', 'options_framework_theme'), 'edit_theme_options', 'options-framework','optionsframework_page');
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Yammer Options', 'options_framework_theme' ),

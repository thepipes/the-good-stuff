...
function roots_google_analytics() {
  ...
  $roots_google_analytics_id = of_get_option('google_analytics_id');
  if ($roots_google_analytics_id !== '') {
    echo "\n\t<script>\n";
    echo "\t\tvar _gaq=[['_setAccount','$roots_google_analytics_id'],['_trackPageview']]; _gaq.push(['_setDomainName', 'yammer.com']);\n";

...
class GFFormDisplay{
    ...
    private static function gform_footer($form, $class, $ajax, $field_values, $previous_button, $display_title, $display_description){
        ...
        $footer = "
        <div class='" . $class ."'>";
        $button_input = self::get_form_button($form["id"], "gform_submit_button_{$form["id"]}", $form["button"], __("Submit", "gravityforms"), "button gform_button yj-btn", __("Submit", "gravityforms"), 0);
    ...
    public static function get_counter_script_init($form){
        ...
        foreach($form["fields"] as $field){
            ...
            {
                $field_script =
                        "if(jQuery('#field_{$form["id"]}_{$field["id"]} .ginput_counter').length == 0){" .
